...
class NewTab(Tab):
    ...
    def createLayout(self):
        ...
        playerInfoButton.clicked.connect(self.parent.openPlayerInfo)
        ...
        gameInfoButton.clicked.connect(self.parent.openGameInfo)
        ...
        serverInfoButton.clicked.connect(self.parent.openServerInfo)
        ...
        mapInfoButton.clicked.connect(self.parent.openMapInfo)
